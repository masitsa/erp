...
$all_nurses = '';
if($adnurses->num_rows() > 0)
{
	foreach($adnurses->result() as $row):
		$adnurse_name = $row->adnurse_name;
		$adnurse_id = $row->adnurse_id;
		
		if($adnurse_id == set_value('adnurse_id'))
		{
			$all_nurses .= "<option value='".$adnurse_id."' selected='selected'>".$adnurse_name."</option>";
		}
		
		else
		{
			$all_nurses .= "<option value='".$adnurse_id."'>".$adnurse_name."</option>";
		}
	endforeach;
}
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<div class="form-group">
								         ...
								         <div class="form-group">
					                         <label class="col-md-4 control-label">Nurse: </label>
					                
					                         <div class="col-md-8">
					                         <input type="text" class="form-control" name="visit_nurse" placeholder="Admission Nurse">
					                        </div>
					                    </div>                                
										<div class="form-group">
