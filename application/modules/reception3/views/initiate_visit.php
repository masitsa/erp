...
<div class="row">
         				  ...
         				  <div class="padd">
					        <div class="form-group">
				                        	...
				                        	<?php
												...
												if($visit_departments->num_rows() > 0){
				                            		foreach($visit_departments->result() as $row):
														...
														{
															echo "<option value='".$department_id."' selected='selected'>".$departments_name."</option>";
														}
                             ...
                             <div class="form-group">
								...
								<div class="col-lg-8">
									<input type="radio" name="visit_type" value="1" checked="checked" onclick="do_patient_type_function(1)"><?php echo $patient_type;?>
                                    <input type="radio" name="visit_type" value="4" onclick="do_patient_type_function(4)"> Insurance
								</div>
                             </div>
							 <?php
                             if(($patient_type == "Other") AND ($patient_type_id == 3))
                             {
								?>
                                <div id="visit_payment">
                                    <div class="form-group">
                                        <label class="col-lg-4 control-label">Visit payment  type: </label>
                                        <div class="col-lg-8">
                                            <input type="radio" name="visit_payment_type" value="1" onclick="do_patient_payment_type_function(1)">Cash
                                            <input type="radio" name="visit_payment_type" value="2" onclick="do_patient_payment_type_function(2)">MPESA
                                            <!--<input type="radio" name="visit_payment_type" value="3" onclick="do_patient_payment_type_function(3)">Salary Deduction
                                            <input type="radio" name="visit_payment_type" value="4" checked="checked" onclick="do_patient_payment_type_function(4)">--> 
                                        </div>
                                    </div>
                                </div>  	
                                <?php 
                            ...
                            <!--<div id="care_of">
                            	<div class="form-group">
									<label class="col-lg-4 control-label">Staff Full Names: </label>
									<div class="col-lg-8">
										<input type="text" name="staff_full_names" class="form-control">
									</div>
								</div>
                                <div class="form-group">
									<label class="col-lg-4 control-label">Staff Faculty: </label>
									<div class="col-lg-8">
										<input type="text" name="staff_faculty" class="form-control">
									</div>
								</div>
                            </div>--> 
 ...
 <script type="text/javascript" charset="utf-8">
	...
	$(document).ready(function(){
      do_patient_payment_type_function(4);
	...
	function do_patient_type_function(patient_type_id)
	{
		...
		{
			$('#insured_company').css('display', 'block');
			$('#visit_payment').css('display','none');
			$('#care_of').css('display','none');
			// $('#consultation').css('display', 'block');
		}
		else
		{
			$('#insured_company').css('display', 'none');
			$('#visit_payment').css('display','block');
			$('#care_of').css('display','none');
			// $('#consultation').css('display', 'block');
		}
		var config_url = $('#config_url').val();
	...
	function do_patient_payment_type_function(payment_type)
	{

		if(payment_type == '4')
		{
			$('#care_of').css('display', 'block');
		}
		else
		{
			$('#care_of').css('display', 'none');
