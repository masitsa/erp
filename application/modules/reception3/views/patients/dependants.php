<?php 
		...
		echo form_open("reception/register_dependant/".$patient_id.'/'.$visit_type_id.'/'.$staff_no, array("class" => "form-horizontal", "id"=>'submit_staff_dependant'));
		?>
	...
	<div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-8">
                ...
                <div id="datetimepicker_dependants" class="input-append">
