...
<div class="widget boxed">
    ...
    <div class="widget-content">
    	<div class="padd">
			<?php
            echo form_open("reception/search_appointment_patients", array("class" => "form-horizontal"));
            ?>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div id="datetimepicker1" class="input-append">
                                <input data-format="yyyy-MM-dd" class="form-control" type="text" name="appointment_date" placeholder="Appointment Date" value="<?php echo set_value('appointment_date');?>">
                                <span class="add-on">
