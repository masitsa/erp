<!-- search -->
<?php echo $this->load->view('patients/search/search_appointment', '', TRUE);?>
<!-- end search -->
...
<?php
		$search = $this->session->userdata('search_appointment_patients');
		
		if(!empty($search))
		{
			echo '<a href="'.site_url().'reception/close_appointment_search" class="btn btn-warning">Close Search</a>';
		}
		$result = '';
