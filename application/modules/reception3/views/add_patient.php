				...
				<div class="padd">
					...
					<div class="tabbable" style="margin-bottom: 18px;">
						<ul class="nav nav-tabs">
							...
							<li><a href="#staff_dependants" data-toggle="tab">Staff Dependants</a></li>
						...
						<div class="tab-content" style="padding-bottom: 9px; border-bottom: 1px solid #ddd;">
							...
							<div class="tab-pane" id="staff_dependants">
								<?php echo $this->load->view("patients/add_staff_dependants", '', TRUE);?>
							</div>
						</div>
					</div>
				</div>
